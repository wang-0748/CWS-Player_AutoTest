...
from pages.gocayin.modules.devicemanagement_page import DeviceManagementPage
# 機器人驗證使用方式
from pages.gocayin.login_page import LoginPage
...
def test_login(driver):
    ...
    # 調整 devicemanagement 設定測試
    dashboard.select_content_type("GO CAYIN device management")
    devicemanagement = DeviceManagementPage(driver)
    devicemanagement.get_register_status()
    print(devicemanagement.get_register_status())
    devicemanagement.click_play()