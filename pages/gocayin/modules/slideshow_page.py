...
class SlideShowPage(BasePage):
    SLIDESHOW_SET = (By.ID, "com.cayintech.cmswsplayer:id/gocayin_slideshow_spinner")
    PREVIEW_IMAGE = (By.ID, "com.cayintech.cmswsplayer:id/gocayin_slideshow_img")
    PLAY_BUTTON = (By.ID, "com.cayintech.cmswsplayer:id/play_btn")

    def select_slideshow_set(self, room_set):
        self.click(self. SLIDESHOW_SET)
